...
def main(
    ...
    assert set(dataset.data.keys()) == {'X_num', 'Y','Y_rank'}, set(dataset.data.keys())#lzd
...
if __name__ == '__main__':
    folder_path='/home/luozhengdong/ordinal_regression/tabR_lzd/exp/xgboost_/cmc/0-tuning/'
