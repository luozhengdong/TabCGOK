...
python bin/go.py /home/luozhengdong/ordinal_regression/tabR_lzd/exp/tabr_classGroup/ablation/oka-ot-k3g10-tuning.toml
...
def main(
    ...
    *,
    ...
    bin.evaluate_go.main(evaluation_input, n_seeds, function, force=force)  ##experiment with 15 random seeds
